...
public class SpeedIVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public SpeedIVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_SPEED_IVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.IVs.Speed = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.IVs.Speed);
    }
