...
public class SPAttackEVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public SPAttackEVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_SP_ATTACK_EVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.EVs.SpecialAttack = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.EVs.SpecialAttack);
    }
