...
public class HPIVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public HPIVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_HP_IVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.IVs.HP = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.IVs.HP);
    }
