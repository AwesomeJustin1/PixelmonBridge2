...
public class DefenseEVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public DefenseEVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_DEFENSE_EVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.EVs.Defence = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.EVs.Defence);
    }
