...
public class DefenseIVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public DefenseIVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_DEFENSE_IVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.IVs.Defence = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.IVs.Defence);
    }
