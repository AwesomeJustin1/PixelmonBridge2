...
public class SpeedEVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public SpeedEVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_SPEED_EVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.EVs.Speed = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.EVs.Speed);
    }
