...
public class BaseStatsSPDefenseValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public BaseStatsSPDefenseValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_BASESTATS_SP_DEFENSE);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.baseStats.spDef = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.baseStats.spDef);
    }
