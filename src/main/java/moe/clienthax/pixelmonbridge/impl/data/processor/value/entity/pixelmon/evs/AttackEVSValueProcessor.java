...
public class AttackEVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public AttackEVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_ATTACK_EVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.EVs.Attack = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.EVs.Attack);
    }
