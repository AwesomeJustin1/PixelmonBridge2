...
public class BaseStatsAttackValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public BaseStatsAttackValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_BASESTATS_ATTACK);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.baseStats.attack = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.baseStats.attack);
    }
