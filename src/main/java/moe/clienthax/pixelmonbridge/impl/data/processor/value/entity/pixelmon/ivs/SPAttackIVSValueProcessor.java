...
public class SPAttackIVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public SPAttackIVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_SP_ATTACK_IVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.IVs.SpAtt = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.IVs.SpAtt);
    }
