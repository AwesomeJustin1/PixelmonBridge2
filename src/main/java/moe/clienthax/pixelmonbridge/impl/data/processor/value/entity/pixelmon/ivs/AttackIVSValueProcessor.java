...
public class AttackIVSValueProcessor extends AbstractSpongeValueProcessor<EntityPixelmon, Integer, Value<Integer>> {

    public AttackIVSValueProcessor() {
        super(EntityPixelmon.class, PixelmonDataKeys.POKEMON_ATTACK_IVS);
    }
    ...
    protected boolean set(EntityPixelmon container, Integer value) {
        container.stats.IVs.Attack = value;
        return true;
    }

    @Override
    protected Optional<Integer> getVal(EntityPixelmon container) {
        return Optional.of(container.stats.IVs.Attack);
    }
